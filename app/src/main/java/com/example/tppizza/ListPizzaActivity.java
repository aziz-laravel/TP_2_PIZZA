...
public class ListPizzaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        */
        ...
        ps.create(new Produit("BARBECUED CHICKEN PIZZA",
                3,
                R.drawable.pizza1,
                "35 min",
        ...
        ps.create(new Produit("BRUSCHETTA PIZZA",
                5,
                R.drawable.pizza2,
                "35 min",
        ...
        ps.create(new Produit("SPINACH PIZZA",
                2,
                R.drawable.pizza3,
                "25 min",
        ...
        ps.create(new Produit("DEEP-DISH SAUSAGE PIZZA",
                8,
                R.drawable.pizza4,
                "45 min",
        ...
        list.setAdapter(new PizzaAdapter(ps.findAll(),this));

        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ListPizzaActivity.this,DetailActivity.class);

                intent.putExtra("photo",ps.findAll().get(position).getPhoto());
                intent.putExtra("nom",ps.findAll().get(position).getNom().toString());
                intent.putExtra("desc",ps.findAll().get(position).getDescription().toString());
                intent.putExtra("ingred",ps.findAll().get(position).getDetaisIngred().toString());
                intent.putExtra("prepa",ps.findAll().get(position).getPreparation().toString());
